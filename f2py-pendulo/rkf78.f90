      ...
      ! INPUT ::
      ! RELERR - ERRO RELATIVO 
      ! ABSERR - ERRO ABSOLUTO
      ! IFLAG - PARAMETRO DE CONTROLE PARA INICIALIAR A SUBROTINA, DEVE SER IGUAL A 1
      ! WORK - VETOR REAL COM DIMENSÃO DE 14*NEQN
      ! DT - PASSO DE TEMPO INICIAL
      ! DT_MAX - PASSO DE TEMPO MÁXIMO
      ! X - EQUAÇÕES
      ! T - TEMPO INICIAL INDEPENDENTE
      ! TOUT - PRÓXIMO TEMPO DESEJADO
      ! OUTPUT ::
      ! DT - PASSO DE TEMPO ALCANÇADO
      ! IFLAG - SE IGUAL A 2 - NORMAL
      !       - SE IGUAL A 7 - MAXIMA TENTATIVA DE UTILIZAR O PASSO ALCANÇADAS, REDUZIR O PASSO DT OU AUMENTAR RELERR & ABSERR
      !       - SE IGUAL A 8 - DT MUITO PEQUENO
      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      !INTEGER :: NEQN = 2
      ...
      ! COEFFICENTES DE FEHLBERG ***** ESTUDAR *****
